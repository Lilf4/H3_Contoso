...
namespace Contoso_MVC_8_0_VS2022.Migrations
{
    ...
    [Migration("20241216072916_ComplexDataModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.CourseAssignment", b =>
                {
                    b.Property<int>("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.Department", b =>
                {
                    b.Property<int>("DepartmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.Course", b =>
                {
                    b.HasOne("Contoso_MVC_8_0_VS2022.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.CourseAssignment", b =>
                {
                    ...
                    b.HasOne("Contoso_MVC_8_0_VS2022.Models.Instructor", "Instructor")
                        .WithMany("CourseAssignments")
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.Department", b =>
                {
                    b.HasOne("Contoso_MVC_8_0_VS2022.Models.Instructor", "Administrator")
                        .WithMany()
                        .HasForeignKey("InstructorID");
            ...
            modelBuilder.Entity("Contoso_MVC_8_0_VS2022.Models.OfficeAssignment", b =>
                {
                    b.HasOne("Contoso_MVC_8_0_VS2022.Models.Instructor", "Instructor")
                        ...
                        .HasForeignKey("Contoso_MVC_8_0_VS2022.Models.OfficeAssignment", "InstructorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
